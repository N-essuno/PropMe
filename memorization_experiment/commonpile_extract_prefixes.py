...
INPUT_PATH = REPO_ROOT / "memorization_experiment" / "data" / "commonpile" / "commonpile_sample_docs.jsonl"
OUTPUT_PATH = REPO_ROOT / "memorization_experiment" / "data" / "commonpile" / "prefix" / "commonpile_prefix_prompts.jsonl"
